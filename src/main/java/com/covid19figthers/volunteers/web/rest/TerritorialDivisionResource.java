...
/**
 * REST controller for managing TerritorialDivision.
 */
@RestController
@RequestMapping("/api")
public class TerritorialDivisionResource {
    ...
    /**
     * POST  /territorial-divisions : Create a new territorialDivision.
     *
     * @param territorialDivision the territorialDivision to create
     * @return the ResponseEntity with status 201 (Created) and with body the new territorialDivision, or with status 400 (Bad Request) if the territorialDivision has already an ID
    ...
    /**
     * PUT  /territorial-divisions : Updates an existing territorialDivision.
     *
     * @param territorialDivision the territorialDivision to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated territorialDivision,
     * or with status 400 (Bad Request) if the territorialDivision is not valid,
     * or with status 500 (Internal Server Error) if the territorialDivision couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<TerritorialDivision> updateTerritorialDivision(@RequestBody TerritorialDivision territorialDivision) throws URISyntaxException {
        ...
        if (territorialDivision.getId() == null) {
            return createTerritorialDivision(territorialDivision);
        }
        TerritorialDivision result = territorialDivisionService.save(territorialDivision);
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, territorialDivision.getId().toString()))
            .body(result);
    }

    /**
     * GET  /territorial-divisions : get all the territorialDivisions.
     *
     * @return the ResponseEntity with status 200 (OK) and the list of territorialDivisions in body
     */
    ...
    /**
     * GET  /territorial-divisions/:id : get the "id" territorialDivision.
     *
     * @param id the id of the territorialDivision to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the territorialDivision, or with status 404 (Not Found)
     */
    ...
    public ResponseEntity<TerritorialDivision> getTerritorialDivision(@PathVariable Long id) {
        ...
        TerritorialDivision territorialDivision = territorialDivisionService.findOne(id);
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(territorialDivision));
    }

    /**
     * DELETE  /territorial-divisions/:id : delete the "id" territorialDivision.
     *
    ...
    /**
     * SEARCH  /_search/territorial-divisions?query=:query : search for the territorialDivision corresponding
     * to the query.
     *
