...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("COVID19Fighters");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("COVID19Fighters");
        ...
        config.getMapConfigs().put("com.covid19figthers.volunteers.domain.*", initializeDomainMapConfig(jHipsterProperties));
